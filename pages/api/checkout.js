...
//   const productsPrices = cartProducts.map(item => item.price);
//   const productsCount = cartProducts.map(item => item.count);
//   console.log("productsPrices:", productsIds);
...
//     const productInfos = productsInfos.filter(p => p._id.toString() === productId);
//     const quantity = productsCount[i];
//     console.log("quantity:", quantity);

//     if (quantity > 0 && productInfos.length > 0) {
//       productInfos.forEach(productInfo => {
//         const unitAmount = productInfo.price[0] * 100; // Use the first price in the array
